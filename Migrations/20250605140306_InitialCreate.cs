        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalToken = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePaymentMethodId = table.Column<Guid>(type: "uuid", nullable: true),
                    DestinationPaymentMethodId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_PaymentMethods_DestinationPaymentMethodId",
                        column: x => x.DestinationPaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_PaymentMethods_SourcePaymentMethodId",
                        column: x => x.SourcePaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_QrCodes_QrCodeId",
                        column: x => x.QrCodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QrCodes_QrCodeData",
                table: "QrCodes",
                column: "QrCodeData",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_DestinationPaymentMethodId",
                table: "Transactions",
                column: "DestinationPaymentMethodId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SourcePaymentMethodId",
                table: "Transactions",
