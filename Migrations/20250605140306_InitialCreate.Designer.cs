...
namespace scan2pay.Migrations
{
    ...
    [Migration("20250605140306_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("scan2pay.Models.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("scan2pay.Models.Commande", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("scan2pay.Models.CommandeArticle", b =>
                {
                    ...
                    b.Property<decimal>("PrixAuMomentDeCommande")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("scan2pay.Models.Facture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("scan2pay.Models.Article", b =>
                {
                    b.HasOne("scan2pay.Models.ApplicationUser", "Marchand")
                        .WithMany("ArticlesMarchand")
                        .HasForeignKey("MarchandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("scan2pay.Models.Commande", b =>
                {
                    b.HasOne("scan2pay.Models.ApplicationUser", "Client")
            ...
            modelBuilder.Entity("scan2pay.Models.CommandeArticle", b =>
                {
                    b.HasOne("scan2pay.Models.Article", "Article")
                        .WithMany("CommandeLinks")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("scan2pay.Models.Commande", "Commande")
            ...
            modelBuilder.Entity("scan2pay.Models.Facture", b =>
                {
                    b.HasOne("scan2pay.Models.Commande", "Commande")
                        .WithOne("Facture")
                        .HasForeignKey("scan2pay.Models.Facture", "CommandeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
